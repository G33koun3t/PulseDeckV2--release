...
const C = {
  fr: {
    ...
    calendar: { name: 'Calendrier', desc: 'Gestion d\u2019agenda avec support multi-calendriers.', features: ['Support de calendriers ICS externes', 'Affichage des \u00e9v\u00e9nements \u00e0 venir', 'Cr\u00e9ation rapide d\u2019\u00e9v\u00e9nements locaux'], setup: 'Ajoutez des URLs de calendriers ICS dans les param\u00e8tres du module.' },
  ...
  en: {
    ...
    calendar: { name: 'Calendar', desc: 'Calendar management with multi-calendar support.', features: ['External ICS calendar support', 'Upcoming events display', 'Quick local event creation'], setup: 'Add ICS calendar URLs in the module settings.' },
  ...
  de: {
    ...
    calendar: { name: 'Kalender', desc: 'Kalenderverwaltung mit Multi-Kalender-Unterst\u00fctzung.', features: ['Externe ICS-Kalender-Unterst\u00fctzung', 'Anzeige bevorstehender Termine', 'Schnelle lokale Terminerstellung'], setup: 'F\u00fcgen Sie ICS-Kalender-URLs in den Moduleinstellungen hinzu.' },
  ...
  nl: {
    ...
    calendar: { name: 'Kalender', desc: 'Agendabeheer met multi-kalender ondersteuning.', features: ['Externe ICS-kalender ondersteuning', 'Weergave van komende afspraken', 'Snel lokale afspraken aanmaken'], setup: 'Voeg ICS-kalender-URLs toe in de moduleinstellingen.' },
  ...
  es: {
    ...
    calendar: { name: 'Calendario', desc: 'Gesti\u00f3n de agenda con soporte multi-calendario.', features: ['Soporte de calendarios ICS externos', 'Visualizaci\u00f3n de pr\u00f3ximos eventos', 'Creaci\u00f3n r\u00e1pida de eventos locales'], setup: 'A\u00f1ada URLs de calendarios ICS en la configuraci\u00f3n del m\u00f3dulo.' },
  ...
  pt: {
    ...
    calendar: { name: 'Calend\u00e1rio', desc: 'Gest\u00e3o de agenda com suporte multi-calend\u00e1rio.', features: ['Suporte de calend\u00e1rios ICS externos', 'Exibi\u00e7\u00e3o de pr\u00f3ximos eventos', 'Cria\u00e7\u00e3o r\u00e1pida de eventos locais'], setup: 'Adicione URLs de calend\u00e1rios ICS nas defini\u00e7\u00f5es do m\u00f3dulo.' },
  ...
  it: {
    ...
    calendar: { name: 'Calendario', desc: 'Gestione agenda con supporto multi-calendario.', features: ['Supporto calendari ICS esterni', 'Visualizzazione eventi imminenti', 'Creazione rapida eventi locali'], setup: 'Aggiungi URL di calendari ICS nelle impostazioni del modulo.' },
  ...
  pl: {
    ...
    calendar: { name: 'Kalendarz', desc: 'Zarz\u0105dzanie kalendarzem z obs\u0142ug\u0105 wielu kalendarzy.', features: ['Obs\u0142uga zewn\u0119trznych kalendarzy ICS', 'Wy\u015bwietlanie nadchodz\u0105cych wydarze\u0144', 'Szybkie tworzenie wydarze\u0144 lokalnych'], setup: 'Dodaj adresy URL kalendarzy ICS w ustawieniach modu\u0142u.' },
  ...
  ja: {
    ...
    calendar: { name: '\u30ab\u30ec\u30f3\u30c0\u30fc', desc: '\u30de\u30eb\u30c1\u30ab\u30ec\u30f3\u30c0\u30fc\u5bfe\u5fdc\u306e\u30b9\u30b1\u30b8\u30e5\u30fc\u30eb\u7ba1\u7406\u3002', features: ['\u5916\u90e8ICS\u30ab\u30ec\u30f3\u30c0\u30fc\u306e\u30b5\u30dd\u30fc\u30c8', '\u4eca\u5f8c\u306e\u30a4\u30d9\u30f3\u30c8\u8868\u793a', '\u30ed\u30fc\u30ab\u30eb\u30a4\u30d9\u30f3\u30c8\u306e\u7d20\u65e9\u3044\u4f5c\u6210'], setup: '\u30e2\u30b8\u30e5\u30fc\u30eb\u8a2d\u5b9a\u3067ICS\u30ab\u30ec\u30f3\u30c0\u30fc\u306eURL\u3092\u8ffd\u52a0\u3057\u3066\u304f\u3060\u3055\u3044\u3002' },
